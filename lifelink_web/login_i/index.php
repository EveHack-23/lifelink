...
if(isset($_POST['email']))
{
	$email=$_POST['email'];
	$psswd=$_POST['psswd'];
	$sql="SELECT * FROM Institution WHERE Email='$email'";
	...
	<section class="vh-100" >
		...
		<div class="row d-flex justify-content-center align-items-center h-100">
		  ...
		  <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
			<form name="login" method="post" action="">
			  ...
			  <h2><b><font color="#be1e2d">Institution</font></b> Login</h2>
			  ...
			  <div class="text-center text-lg-start mt-4 pt-2">
				...
				<p class="small fw-bold mt-2 pt-1 mb-0">Want to be a part of Life Link? <a href="signup.php"
	  ...
	  <div
		...
		<div class="text-white mb-3 mb-md-0">
          ...
          <a href="../" style="color:white"> Volunteer Login </a>
		</div>
		<!-- Copyright -->
